...
For information on accessing an API key from a deployed Overture platform, [**see our platform guide here**](https://docs.overture.bio/guides/user-guides/cli-submissions#generate-an-api-key). 

For information on generating and managing API keys in Overture using Keycloak, [**see our administration guide on identity & access management here**](https://docs.overture.bio/guides/administration-guides).
:::
