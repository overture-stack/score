...
**What is a Manifest?** To understand more about key terms in Overture's data workflows, check this guide on [data submission using Song and Score](../../01-Song/03-Usage/01-submitting-data.md).
