...
/**
 * Copy paste from the original by with {@link #getClassLoader()} added.
 * 
 * @see http://docs.spring.io/spring-boot/docs/current/reference/html/executable-jar.html#executable-jar-system-
 * classloader
 */
...
public final class NativeRuntime extends AbstractRuntime {
  ...
  private static ClassLoader getClassLoader() {
    // Needed to work with Spring Boot. See class header.
  ...
  private final NativeClosureManager closureManager = new NativeClosureManager(this,
      ...
      new AsmClassLoader(getClassLoader()));
