...
public class MergedServerTokenServicesTest {
  ...
  public void beforeTest() {
    ...
    mergedServerTokenServices =
        new MergedServerTokenServices(jwtTokenServices, remoteTokenServices, retryTemplate);
  }
  ...
  public void accessTokenResolution_jwt_success() {
    val jwtString =
        jwtGenerator.generateJwtWithContext(buildJwtContext(List.of("score.WRITE")), false);
